...
import { captureRequestLog } from "./middleware/observability.js";
...
import { integrationRouter, observabilityRouter } from "./routes/integration.js";
...
app.use("/services/observability", observabilityRouter);
